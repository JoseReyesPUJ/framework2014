...
MatrizJimages::MatrizJimages(int size_)
{
    ...
    ventanaJuegoImagenes = new VentanaMatrizImages();
    ventanaJuegoImagenes->construcAobligatorio(matrizControl,sizeMatriz);
    //ventana->show();


}

void MatrizJimages::mostrarVentanaImagenes()
{
    ventanaJuegoImagenes->show();
}


void MatrizJimages::setSegundaVentana(ventanaLetrasJuego *v_)
{
    ventanaLetasJ = v_;
    ventanaJuegoImagenes->setSegundaVentana(ventanaLetasJ);
}
